	...
	db.transaction(function (tx) {
		tx.executeSql(sqlStatement, [], function (tx, result) {
			...
			for (var i = 0, item = null; i < dataset.length; i++) {
				...
				"<a href='#' data-theme='b' class='ui-btn ui-icon-delete ui-btn-icon-notext ui-corner-all ui-btn-hover-b ui-btn-up-b' onclick='exeSQL(\"DELETE FROM tblJurusan WHERE idJurusan="+item['idJurusan']+"\");showDaftarJurusan()'></a></td></tr>"
	...
	for (var j=0; j<=jmlSiswa-1; j++){  
      (function(j) {
        db.transaction(function (tx) {  
			...
			console.log("idSiswa="+idSiswa);
			//$("#nilai-j").val(j);
			s1 = "SELECT *, (SELECT txtIndikator FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS indikator, (SELECT idPenilaian FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS idPenilaian, (SELECT bobot FROM tblPenilaian WHERE idPenilaian=1) AS bobot, (SELECT txtPenilaian FROM tblPenilaian WHERE idPenilaian=1) AS komponen FROM tblDaftarNilai WHERE idSiswa="+idSiswa+" AND idMapel="+idMapel+" AND idPertemuan="+idKompetensi+" AND idPenilaian=1";
			s2 = "SELECT *, (SELECT txtIndikator FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS indikator, (SELECT idPenilaian FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS idPenilaian, (SELECT bobot FROM tblPenilaian WHERE idPenilaian=2) AS bobot, (SELECT txtPenilaian FROM tblPenilaian WHERE idPenilaian=2) AS komponen FROM tblDaftarNilai WHERE idSiswa="+idSiswa+" AND idMapel="+idMapel+" AND idPertemuan="+idKompetensi+" AND idPenilaian=2";
			s3 = "SELECT *, (SELECT txtIndikator FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS indikator, (SELECT idPenilaian FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS idPenilaian, (SELECT bobot FROM tblPenilaian WHERE idPenilaian=3) AS bobot, (SELECT txtPenilaian FROM tblPenilaian WHERE idPenilaian=3) AS komponen FROM tblDaftarNilai WHERE idSiswa="+idSiswa+" AND idMapel="+idMapel+" AND idPertemuan="+idKompetensi+" AND idPenilaian=3";
			s4 = "SELECT *, (SELECT txtIndikator FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS indikator, (SELECT idPenilaian FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS idPenilaian, (SELECT bobot FROM tblPenilaian WHERE idPenilaian=4) AS bobot, (SELECT txtPenilaian FROM tblPenilaian WHERE idPenilaian=4) AS komponen FROM tblDaftarNilai WHERE idSiswa="+idSiswa+" AND idMapel="+idMapel+" AND idPertemuan="+idKompetensi+" AND idPenilaian=4";
			s5 = "SELECT *, (SELECT txtIndikator FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS indikator, (SELECT idPenilaian FROM tblIndikator WHERE idIndikator=tblDaftarNilai.idIndikator) AS idPenilaian, (SELECT bobot FROM tblPenilaian WHERE idPenilaian=5) AS bobot, (SELECT txtPenilaian FROM tblPenilaian WHERE idPenilaian=5) AS komponen FROM tblDaftarNilai WHERE idSiswa="+idSiswa+" AND idMapel="+idMapel+" AND idPertemuan="+idKompetensi+" AND idPenilaian=5";
			tx.executeSql(s1, [], function (tx, result) {
				dataset = result.rows
				console.log(idSiswa);
				for (var i = 0, item = null; i < dataset.length; i++) {
